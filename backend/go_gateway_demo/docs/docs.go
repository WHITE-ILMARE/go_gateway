...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "WHITE-ILMARE",
            "url": "https://github.com/WHITE-ILMARE",
            "email": "2480800244@qq.com"
        },
        "license": {
            "name": "Apach 2.0",
    ...
    "definitions": {
        ...
        "dto.ServiceAddGrpcInput": {
            ...
            "properties": {
                ...
                "open_auth": {
                    "description": "gateway_access_control表字段",
                    "type": "integer",
                    "maximum": 1,
                    "minimum": 0
                },
                "port": {
                    "description": "gateway_service_grpc_rule表字段",
                    "type": "integer",
                    "maximum": 8999,
                    "minimum": 8001
                },
                "round_type": {
                    "description": "gateway_load_balance相关",
                    "type": "integer",
                    "maximum": 3,
                    "minimum": 0
                },
        ...
        "dto.ServiceAddTcpInput": {
            ...
            "properties": {
                ...
                "port": {
                    "description": "gateway_service_tcp_rule表字段",
                    "type": "integer",
                    "maximum": 8999,
                    "minimum": 8001
                },
